...
pub fn glyph_enable() {
    GLYPHS_ENABLED.store(true, Ordering::SeqCst);
}
pub fn set_glyphs_enabled(enable: bool) {
    GLYPHS_ENABLED.store(enable, Ordering::SeqCst);
}
pub fn glyphs_enabled() -> bool {
    GLYPHS_ENABLED.load(Ordering::SeqCst)
}
