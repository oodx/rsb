...
pub fn setup_rsb_paths() {
    crate::global::set_var(
        "RSB_LIB_HOME",
        &crate::global::expand_vars("$XDG_LIB_HOME/rsb"),
    );
    crate::global::set_var("RSB_ETC_HOME", &crate::global::expand_vars("$XDG_ETC_HOME"));
    crate::global::set_var(
        "RSB_DATA_HOME",
        &crate::global::expand_vars("$XDG_DATA_HOME/rsb"),
    );
    // BashFX-style bin flattening for rsb tools
    crate::global::set_var(
        "RSB_BIN_HOME",
        &crate::global::expand_vars("$XDG_BIN_HOME/rsb"),
    );
}
