...
fn uat_param_usage_demo() {
    ...
    println!("default: EMPTY -> '{}'", param!("EMPTY", default: "fallback"));
    ...
    println!("prefix: FOO '/home' -> '{}'", param!("FOO", prefix: "/home"));
    println!("suffix: FOO '.txt'  -> '{}'", param!("FOO", suffix: ".txt"));
    println!("replace: FOO '/'=>'_'      -> '{}'", param!("FOO", replace: "/" => "_"));
    println!("replace: FOO '/'=>'_' all  -> '{}'", param!("FOO", replace: "/" => "_", all));
    ...
    let args = rsb::cli::Args::new(&["bin".into(), "cmd".into(), "--verbose".into(), "--config=demo.conf".into(), "-d".into()]);
    options!(&args);
    println!("opt_verbose='{}' opt_config='{}' opt_d='{}'", param!("opt_verbose"), param!("opt_config"), param!("opt_d"));
